...
const [bins, setBins] = useState({
  ...
  const binAlmostFull = "https://raw.githubusercontent.com/ebtesam25/ideahacks2022/main/app/src/assets/red.png"
  const binEmpty = "https://raw.githubusercontent.com/ebtesam25/ideahacks2022/main/app/src/assets/yellow.png"
  const binFull = "https://raw.githubusercontent.com/ebtesam25/ideahacks2022/main/app/src/assets/green.png"
  ...
  return isLoaded ? (
      ...
      >
        ...
        {bins.bins.map((item, i) => (
            <Marker
            icon={item.level>75?binAlmostFull:(item.level>90?binFull:binEmpty)}
